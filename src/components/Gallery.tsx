...
export const Gallery: React.FC = () => {
  ...
  const images = [
    { src: '/1.webp', alt: 'Dom na Roztoczu - widok zewnętrzny' },
    { src: '/2.webp', alt: 'Dom na Roztoczu - widok zewnętrzny' },
    { src: '/3.webp', alt: 'Wnętrze domu' },
    { src: '/4.webp', alt: 'Strefa wypoczynkowa' },
    { src: '/5.webp', alt: 'Detale wystroju' },
    { src: '/6.webp', alt: 'Okolica i natura' },
    { src: '/7.webp', alt: 'Taras i ogród' },
    { src: '/8.webp', alt: 'Udogodnienia' },
    { src: '/9.webp', alt: 'Klimat miejsca' },
    { src: '/10.webp', alt: 'Dom na Roztoczu - widok zewnętrzny' },
    { src: '/11.webp', alt: 'Wnętrze domu' },
    { src: '/12.webp', alt: 'Strefa wypoczynkowa' },
    { src: '/13.webp', alt: 'Detale wystroju' },
    { src: '/14.webp', alt: 'Okolica i natura' },
    { src: '/15.webp', alt: 'Taras i ogród' },
    { src: '/16.webp', alt: 'Udogodnienia' },
    { src: '/17.webp', alt: 'Taras i ogród' },
    { src: '/18.webp', alt: 'Udogodnienia' },
  ];
